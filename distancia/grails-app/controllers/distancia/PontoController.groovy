...
class PontoController {
    ...
    def save(Ponto pontoInstance) {
        ...
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.created.message', args: [message(code: 'ponto.label', default: 'Ponto'), pontoInstance.id])
    ...
    protected void notFound() {
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.not.found.message', args: [message(code: 'ponto.label', default: 'Ponto'), params.id])
                redirect action: "index", method: "GET"
            }
