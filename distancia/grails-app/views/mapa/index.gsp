		...
		<div id="list-mapa" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="nome" title="${message(code: 'mapa.nome.label', default: 'Nome')}" />
				...
				<g:each in="${mapaInstanceList}" status="i" var="mapaInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${mapaInstance.id}">${fieldValue(bean: mapaInstance, field: "nome")}</g:link></td>
