	...
	<body>
		...
		<div id="show-ponto" class="content scaffold-show" role="main">
			...
			<ol class="property-list ponto">
				...
				<g:if test="${pontoInstance?.letra}">
				<li class="fieldcontain">
					<span id="letra-label" class="property-label"><g:message code="ponto.letra.label" default="Letra" /></span>
					
						<span class="property-value" aria-labelledby="letra-label"><g:fieldValue bean="${pontoInstance}" field="letra"/></span>
