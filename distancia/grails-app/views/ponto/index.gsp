		...
		<div id="list-ponto" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="letra" title="${message(code: 'ponto.letra.label', default: 'Letra')}" />
				...
				<g:each in="${pontoInstanceList}" status="i" var="pontoInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${pontoInstance.id}">${fieldValue(bean: pontoInstance, field: "letra")}</g:link></td>
